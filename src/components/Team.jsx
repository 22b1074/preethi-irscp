                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        {teamMembers.map((member) => (
                            <li 
                                key={member.name} 
                                className="border rounded-lg p-4 text-center bg-gray-200 shadow-lg hover:bg-gray-300 hover:shadow-xl transition-all duration-300" // Darker shadow on hover
